...
### Added — inventory (62 bound features, the §12 set plus documented extras)
...
- Migrated all prior families to the v5 contract and rounded out the §12 set: `ret_log_1/5/21/252`,
  ...
  `vol_yz_21`, `atr_14`; `vol_z_21`, `rel_volume_21`, `amihud_21`, `vwap_dist_close`, `cmf_21`,
  `mfi_14`, `roll_spread_21`, `spread_corwin_schultz`; `skew_21`, `kurt_21`, `downside_dev_21`,
  `up_down_vol_ratio_21`; `zscore_close_21`, `autocorr_1_21`, `var_ratio_2_21`; `season_dow`,
  `season_tom_3`; `xs_rank_mom_252`, `xs_z_mom_252`, `rev_1m_21`.
- Drifted extras with no §12 equivalent (`adx_14`, `half_life_60`, `adv_21`, `signed_vol_21`,
  `dollar_vol`, price-level `sma_*`/`ema_*`) are retained and documented as "beyond §12".
- Deferred from this cut (Tier-1.1, need machinery not yet wired): `bb_pctb_20_2`/`bb_bw_20_2`
  (Bollinger) and the `market_ret`-factor features `beta_252` / `idio_vol_252`.
