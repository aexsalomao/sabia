...
- Feature families: returns, volatility, momentum, trend, volume, distribution, mean_reversion,
  seasonality, cross_sectional. (`microstructure` is enum-only; the module ships later.)
